...
<button onclick="redirectGetContact()" class="btn btn-primary button" type="button" style="position: absolute; left: 30px; top: 500px; width: 150px;">Zoek Contact</button>